...
const demoTools = [
  DemoTool(
    ...
    supportedInputs: ['Prompt', 'Reference image'],
    outputType: 'Image',
    estimatedCost: 80,
    available: true,
  ...
  DemoTool(
    ...
    supportedInputs: ['Prompt', 'Image source'],
    outputType: 'Video',
    estimatedCost: 240,
    available: true,
  ...
  DemoTool(
    ...
    supportedInputs: ['Image source', 'Motion prompt'],
    outputType: 'Video',
    estimatedCost: 180,
    available: false,
...
const demoTemplates = [
  DemoTemplate(
    ...
    requiredInputs: ['Product photo', 'Benefit', 'Target audience'],
  ...
  DemoTemplate(
    ...
    requiredInputs: ['Prompt', 'Format', 'Main claim'],
    defaultToolId: 'video-hook',
    estimatedCost: 220,
  ...
  DemoTemplate(
    ...
    requiredInputs: ['Product reference', 'Model style'],
  ...
  DemoTemplate(
    ...
    requiredInputs: ['Product photo', 'Mood', 'Scene'],
  ...
  DemoTemplate(
    ...
    requiredInputs: ['Product', 'Skin tone', 'Benefit'],
    defaultToolId: 'photo-studio',
    estimatedCost: 120,
  ...
  DemoTemplate(
    ...
    requiredInputs: ['Product', 'Audience', 'Hook'],
    defaultToolId: 'video-hook',
    estimatedCost: 180,
  ...
  DemoTemplate(
    ...
    requiredInputs: ['Prompt', 'Lighting', 'Camera angle'],
    defaultToolId: 'photo-studio',
    estimatedCost: 160,
